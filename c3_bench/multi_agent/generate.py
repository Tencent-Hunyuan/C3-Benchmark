...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--user-model", type=list, default=["hunyuan-turbos-latest"], help="Model used by the user agent"
    )
    parser.add_argument(
        "--planner-model", type=str, default="hunyuan-turbos-latest", help="Model used by the planner agent"
    )
    parser.add_argument(
        "--tool-model", type=str, default="hunyuan-turbos-latest", help="Model used by the tool agent"
    )
    parser.add_argument(
        "--agent-model", type=str, default="hunyuan-turbos-latest", help="Model used by the AI agent"
    )
    parser.add_argument(
        "--checker-model", type=str, default="hunyuan-turbos-latest", help="Model used by the checker agent"
    )
